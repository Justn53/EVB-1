...
Begin VB.Form frmEditor_Item 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbType 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":3336
         Left            =   120
         List            =   "frmEditor_Item.frx":3355
         Style           =   2  'Dropdown List
         TabIndex        =   20
         Top             =   1200
         Width           =   2655
...
Private Sub cmbType_Click()
    ...
    ' Change the defence/damage label
    If fraEquipment.Visible Then
        Select Case Item(EditorIndex).Type
            Case ITEM_TYPE_WEAPON
                lblDamage.Caption = "Damage: " & scrlDamage.value
            Case Else
                lblDamage.Caption = "Defence: " & scrlDamage.value
        End Select
    End If
